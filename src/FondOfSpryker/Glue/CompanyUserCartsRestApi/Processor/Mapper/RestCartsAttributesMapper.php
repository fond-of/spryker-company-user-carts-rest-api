...
{
    /**
     * @var \FondOfSpryker\Glue\CompanyUserCartsRestApi\Processor\Mapper\RestCartsDiscountsMapperInterface
     */
    protected $restCartsDiscountsMapper;

    /**
     * @var \FondOfSpryker\Glue\CompanyUserCartsRestApi\Processor\Mapper\RestCartsTotalsMapperInterface
     */
    protected $restCartsTotalsMapper;

    /**
     * @param \FondOfSpryker\Glue\CompanyUserCartsRestApi\Processor\Mapper\RestCartsDiscountsMapperInterface $restCartsDiscountsMapper
     * @param \FondOfSpryker\Glue\CompanyUserCartsRestApi\Processor\Mapper\RestCartsTotalsMapperInterface $restCartsTotalsMapper
     */
